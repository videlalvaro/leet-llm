...
import Foundation
import LeetLLMCore
import LeetLLMExercises
import LeetLLMSolutions
...
public enum LeetLLMCommand {
	...
	private static func showProblem(_ problemID: String) {
		...
		print("\nRun 'swift run leetllm learn \(problemID)' for the learning sequence.")
	}
	...
	private static func printLearningPath(_ problemID: String) {
		...
		print("   swift run leetllm check \(problemID) --cpu\n")
		var nextStep = 3
		if let metalFile = runner.metalFile {
			print("\(nextStep). Implement the Metal exercise:\n   \(metalFile)")
			print("   swift run leetllm check \(problemID) --metal\n")
			nextStep += 1
		}
		print("\(nextStep). Check the complete learner implementation:")
		print("   swift run leetllm check \(problemID)\n")
		nextStep += 1
		print("\(nextStep). Verify the harness with the canonical answer:")
		print("   swift run leetllm check \(problemID) --solution\n")
		if problemID == "047" {
			nextStep += 1
			print("\(nextStep). Run the complete canonical engine report:")
			print("   swift run -c release leetllm capstone --prompt \"ab c.\" --max-tokens 4\n")
		} else if problemID == "044" {
			nextStep += 1
			print("\(nextStep). Profile prefill and decode independently:")
			print("   swift run -c release leetllm profile 044 --prompt-tokens 16 --trials 7 --decode-steps 4\n")
		} else if problemID == "041" {
			nextStep += 1
			print("\(nextStep). Print the chapter's deterministic arena report:")
			print("   swift run leetllm benchmark 041 --tokens 128 --cached-tokens 128\n")
			...
			|| problemID == "033" || problemID == "043"
		{
			...
			print("   swift run -c release leetllm benchmark \(problemID)\n")
		}
...
#if DEBUG
		print("Note: use 'swift run -c release leetllm benchmark 001' for meaningful timings.")
#endif
...
#if DEBUG
		print("Note: use 'swift run -c release leetllm benchmark 006' for meaningful timings.")
#endif
	...
	private static func benchmarkKVLayouts(arguments: [String]) throws {
		...
		let configuration = try KVCacheConfiguration(
			...
			capacity: tokens)
#if DEBUG
		print("Note: use 'swift run -c release leetllm benchmark 024' for meaningful timings.")
#endif
...
#if DEBUG
		print("Note: use 'swift run -c release leetllm benchmark 033' for meaningful timings.")
#endif
...
#if DEBUG
		print("Note: use 'swift run -c release leetllm benchmark 043' for meaningful timings.")
#endif
...
public enum RuntimeRegistry {
	public static func runner(for problemID: String) -> ProblemRunner? {
		...
		case "001":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P001VectorDotExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P001VectorDot.metal",
		...
		case "002":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P002TensorStorageExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "003":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P003TransposeExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P003Transpose.metal",
				cpuCheck: { useSolution in
		...
		case "004":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P004GEMVExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P004GEMV.metal",
				cpuCheck: { useSolution in
		...
		case "005":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P005GEMMExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P005GEMM.metal",
				cpuCheck: { useSolution in
		...
		case "006":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P006RooflineExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "007":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P007ActivationExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P007Activation.metal",
				cpuCheck: { useSolution in
		...
		case "008":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P008SwiGLUExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P008SwiGLU.metal",
				cpuCheck: { useSolution in
		...
		case "009":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P009SoftmaxExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P009Softmax.metal",
				cpuCheck: { useSolution in
		...
		case "010":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P010RMSNormExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P010RMSNorm.metal",
				cpuCheck: { useSolution in
		...
		case "011":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P011ResidualPrecisionExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "012":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P012FusedRMSNormGEMVExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P012FusedRMSNormGEMV.metal",
				cpuCheck: { useSolution in
		...
		case "013":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P013EmbeddingExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P013Embedding.metal",
				cpuCheck: { useSolution in
		...
		case "014":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P014QKVProjectionExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "015":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P015RoPEExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P015RoPE.metal",
				cpuCheck: { useSolution in
		...
		case "016":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P016CausalAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P016CausalAttention.metal",
				cpuCheck: { useSolution in
		...
		case "017":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P017MultiHeadAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P017MultiHeadAttention.metal",
				cpuCheck: { useSolution in
		...
		case "018":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P018GroupedQueryAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P018GroupedQueryAttention.metal",
				cpuCheck: { useSolution in
		...
		case "019":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P019OnlineAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P019OnlineAttention.metal",
				cpuCheck: { useSolution in
		...
		case "020":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P020TiledAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P020TiledAttention.metal",
				cpuCheck: { useSolution in
		...
		case "021":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P021SlidingWindowAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P021SlidingWindowAttention.metal",
				cpuCheck: { useSolution in
		...
		case "022":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P022ContiguousKVCacheExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "023":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P023CachedAttentionExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P023CachedAttention.metal",
				cpuCheck: { useSolution in
		...
		case "024":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P024KVLayoutShootoutExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "025":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P025SharedKVHeadsExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "026":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P026RingKVCacheExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "027":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P027PagedKVCacheExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "028":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P028QuantizedKVCacheExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P028QuantizedKVCache.metal",
				cpuCheck: { useSolution in
		...
		case "029":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P029SymmetricInt8Exercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "030":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P030GroupwiseInt8Exercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "031":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P031PackQ4Exercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "032":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P032DequantizeThenGEMVExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "033":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P033FusedQ4GEMVExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P033FusedQ4GEMV.metal",
				cpuCheck: { useSolution in
		...
		case "034":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P034QuantizationPropagationExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "035":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P035DecoderBlockExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "036":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P036WeightContainerExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "037":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P037ByteBPEExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "038":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P038LogitsSamplingExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "039":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P039PromptPrefillExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "040":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P040AutoregressiveDecodeExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "041":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P041BufferPlanningExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "042":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P042CheckpointParityExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "043":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P043FusedQKVExercise.swift"],
				metalFile: "Sources/LeetLLMExercises/Metal/P043FusedQKV.metal",
				cpuCheck: { useSolution in
		...
		case "044":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P044PrefillDecodeProfilingExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "045":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P045BatchSchedulingExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "046":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P046SpeculativeDecodingExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
		...
		case "047":
			ProblemRunner(
				exerciseFiles: ["Sources/LeetLLMExercises/P047CapstoneExercise.swift"],
				metalFile: nil,
				cpuCheck: { useSolution in
...
private extension LeetLLMCommand {
	private static func printUsage() {
		print(
			...
			Usage:
			  leetllm list
			  leetllm learn <problem-id>
			  leetllm show <problem-id>
			  leetllm check <problem-id | start-end> [--cpu | --metal] [--solution]
			                 [--format text | jsonl]
			  leetllm benchmark 001 [--size N] [--iterations N]
			  leetllm benchmark 006 [--m M] [--k K] [--n N] [--iterations N]
			                         [--peak-gflops N] [--bandwidth-gbps N]
			  leetllm benchmark 024 [--layers L] [--tokens T] [--heads H]
			                         [--dimension D] [--iterations N]
			  leetllm benchmark 033 [--out O] [--in I] [--group-size G]
			                         [--iterations N]
			  leetllm benchmark 041 [--tokens S] [--cached-tokens T]
			  leetllm benchmark 043 [--tokens S] [--iterations N]
			  leetllm profile 044 [--prompt-tokens S] [--trials N] [--warmup N]
			                      [--decode-steps N]
			  leetllm benchmark 044 [same options as profile 044]
			  leetllm capstone [--prompt TEXT] [--max-tokens N] [--seed N] [--no-metal]
