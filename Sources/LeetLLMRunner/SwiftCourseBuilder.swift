...
enum SwiftCourseBuilder {
    static func build(
        ...
        let executableURL = outputRoot.appending(path: "leetllm")
        ...
        let exerciseAccessor = outputRoot.appending(path: "LeetLLMExercises-Bundle.swift")
        let solutionAccessor = outputRoot.appending(path: "LeetLLMSolutions-Bundle.swift")
        try resourceAccessor(moduleName: "LeetLLMExercises").write(
            to: exerciseAccessor,
            atomically: true,
            encoding: .utf8
        )
        try resourceAccessor(moduleName: "LeetLLMSolutions").write(
            to: solutionAccessor,
            atomically: true,
            encoding: .utf8
        )
        ...
        let modules = [
            Module(
                name: "LeetLLMCore",
                sourceDirectory: "Sources/LeetLLMCore"
            ),
            Module(
                name: "LeetRunnerProtocol",
                sourceDirectory: "Sources/LeetRunnerProtocol"
            ),
            Module(
                name: "LeetLLMExercises",
                sourceDirectory: "Sources/LeetLLMExercises",
                additionalSources: [exerciseAccessor]
            ),
            Module(
                name: "LeetLLMSolutions",
                sourceDirectory: "Sources/LeetLLMSolutions",
                additionalSources: [solutionAccessor]
            ),
            Module(
                name: "LeetLLMRuntime",
                sourceDirectory: "Sources/LeetLLMCLI"
            ),
        ]
        ...
        let entryPoint = workspaceURL.appending(path: "Sources/LeetLLMCLIEntry/main.swift")
        ...
        try copyResources(
            named: "LeetLLMExercises",
            from: workspaceURL.appending(
                path: "Sources/LeetLLMExercises/Metal",
                directoryHint: .isDirectory
            ),
            to: outputRoot
        )
        try copyResources(
            named: "LeetLLMSolutions",
            from: workspaceURL.appending(
                path: "Sources/LeetLLMSolutions/Metal",
                directoryHint: .isDirectory
            ),
            to: outputRoot
        )
        ...
        extension Foundation.Bundle {
            static nonisolated let module: Bundle = {
                let path = Bundle.main.bundleURL
                    .appendingPathComponent("LeetLLM_\(moduleName).bundle")
                    .path
        ...
        throws
    {
        ...
        let bundle = root.appending(
            path: "LeetLLM_\(moduleName).bundle",
            directoryHint: .isDirectory
        )
